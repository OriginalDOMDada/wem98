...
<div class="box-header" @mouseover="dragOn" @mouseleave="dragOff">
    <div class="title-box">
      ...
      <div class="button-section">
        <button v-on:click="explode" class="opt red" type="button" name="expand"><svgicon v-on:click="appData.applications.aboutme.openApp = false" name="close" height="6" width="6" :original="true"></svgicon></button>
...
export default {
  ...
  methods: {
    ...
    mannie: function () {
      ...
      document.querySelector('.app-content p')['0'].style.color = '#00ff80'
    },
    unicorn: function () {
      document.getElementsByClassName('panel')['0'].style.WebkitAnimation = 'inherit'
